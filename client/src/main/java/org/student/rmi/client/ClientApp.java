package org.student.rmi.client;
...
public class ClientApp extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        stage = primaryStage;
        scene = new Scene(loadFXML("LoginView"), 640,378);
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(ClientApp.class.getResource("/org/student/rmi/client/" + fxml + ".fxml"));
